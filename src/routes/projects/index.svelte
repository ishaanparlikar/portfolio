...
<div class="flex flex-wrap justify-start gap-8 h-full max-w-7xl mx-auto items-center">
	...
	<div class="card_ w-[30%] mx-auto relative border">
		<div class="bg-secondary p-3 card_data flex flex-1">
			...
			<div class="flex gap-2">
				<a class="text-primary hover:scale-110" href="/"><Icon height="20" width="20" icon="charm:github" /></a>
				<a class="text-primary hover:scale-110" href="/"><Icon height="20" width="20" icon="line-md:external-link" /></a>
			</div>
		</div>
